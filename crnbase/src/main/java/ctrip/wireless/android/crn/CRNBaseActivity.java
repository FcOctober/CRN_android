...
public class CRNBaseActivity extends FragmentActivity implements
    ...
    private void renderCRNBaseFragment() {
        ...
        try {
            ...
            bundle.putSerializable(CRNBaseFragment.CRNURL_KEY, mCRNURL.getUrl());
            bundle.putString(CRNBaseFragment.CRNURL_INITPARAMS, mCRNURL.initParams);
    ...
    public ReactInstanceManager getReactInstanceManager() {
        return mCRNBaseFragment == null ? null : mCRNBaseFragment.getReactInstanceManager();
    }
